...
## Reference Paper
- [Domain Randomization in Robotic Control](https://github.com/305909/gym-hopper-reinforcement/blob/main/docs/gym-hopper-reinforcement-ACM.pdf)
...
!python /content/gym-hopper-reinforcement/src/train/MCP-train.py \
        --train \
        --test \
        --render \
        --device cuda \
...
!python /content/gym-hopper-reinforcement/src/train/A2C-train.py \
        --train \
        --test \
        --render \
        --device cuda \
...
!python /content/gym-hopper-reinforcement/src/train/PPO-train.py \
        --train \
        --test \
        --render \
        --device cuda \
...
!python /content/gym-hopper-reinforcement/src/fine-tune/MCP-fine-tune.py \
        --train-episodes 10000 \
        --test-episodes 100 \
        --device 'cuda'
```
...
!python /content/gym-hopper-reinforcement/src/fine-tune/A2C-fine-tune.py \
        --train-episodes 10000 \
        --test-episodes 100 \
        --device 'cuda'
```
...
!python /content/gym-hopper-reinforcement/src/fine-tune/PPO-fine-tune.py \
        --train-episodes 10000 \
        --test-episodes 100 \
        --device 'cuda'
```
...
!python /content/gym-hopper-reinforcement/src/train/DROID-train.py \
        --train \
        --test \
        --render \
        --device cuda \
